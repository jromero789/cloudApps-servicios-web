...
public class DatabaseInitializer {
    ...
    @PostConstruct
    public void init() {
        User user1 = new User("Alex", "alex@gmail.com", "1234");
        User user2 = new User("Jesus", "jesus@gmail.com", "1234");
        ...
        Role role1 = new Role(0, ERoles.ROLE_ADMIN);
        Role role2 = new Role(1, ERoles.ROLE_USER);
