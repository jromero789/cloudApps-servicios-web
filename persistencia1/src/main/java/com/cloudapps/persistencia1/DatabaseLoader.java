...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Flight flight = flightRepository.save(new Flight("FLIGHT-001", "Iberia", airplane, airportDeparture, airportArrival, new Date(System.currentTimeMillis()-20000000), (float) 10.5, crewMembers));
    
        Mechanic mechanic = mechanicRepository.save(new Mechanic("EMP-001", "Ana", "Correa", "Iberia", 2004, Training.FP));

        Review review1 = reviewRepository.save(new Review(airplane, new Date(System.currentTimeMillis()-50000000), new Date(System.currentTimeMillis()), 30, mechanic, Type.REPAIR, "Fix flaps", airportDeparture));
        Review review2 = reviewRepository.save(new Review(airplane, new Date(System.currentTimeMillis()-40000000), new Date(System.currentTimeMillis()), 50, mechanic, Type.REPAIR, "Fix wind", airportDeparture));
